/**
 * Copied from https://github.com/typesafehub/akka-contrib-extra/blob/master/src/main/scala/akka/contrib/process/NonBlockingProcess.scala
 * Copyright (C) 2017 Lightbend Inc. <http://www.lightbend.com>
 */

package domino.fs2nuprocess
...
object NonBlockingProcess {
  ...
  case class Started(
    pid: Long,
    stdin: Sink[IO, ByteString],
    stdout: Stream[IO, ByteString],
    stderr: Stream[IO, ByteString]) extends NoSerializationVerificationNeeded
